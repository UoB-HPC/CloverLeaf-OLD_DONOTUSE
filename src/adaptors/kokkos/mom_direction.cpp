...
struct mom_direction_x3_functor {
    ...
    void compute()
    {
        parallel_for("mom_direction_x3", MDRangePolicy<Rank<2>>({y_from, x_from}, {y_to+1, x_to+1}), *this);
    }
...
struct mom_direction_y3_functor {
    ...
    void compute()
    {
        parallel_for("mom_direction_y3", MDRangePolicy<Rank<2>>({y_from, x_from}, {y_to+1, x_to+1}), *this);
    }
...
struct mom_direction_x4_functor {
    ...
    void compute()
    {
        parallel_for("mom_direction_x4", MDRangePolicy<Rank<2>>({y_from, x_from}, {y_to+1, x_to+1}), *this);
    }
...
struct mom_direction_y4_functor {
    ...
    void compute()
    {
        parallel_for("mom_direction_y4", MDRangePolicy<Rank<2>>({y_from, x_from}, {y_to+1, x_to+1}), *this);
    }
