...
void allocate()
{
    ...
    for (int tile = 0; tile < tiles_per_chunk; tile++) {
        ...
        chunk.tiles[tile].field.volume   = new Kokkos::View<double** >("volume", size1d(xmin - 2, xmax + 2), size1d(ymin - 2, ymax + 3));
        chunk.tiles[tile].field.xarea    = new Kokkos::View<double** >("xarea",  size1d(xmin - 2, xmax + 3), size1d(ymin - 2, ymax + 2));
        chunk.tiles[tile].field.yarea    = new Kokkos::View<double** >("yarea",  size1d(xmin - 2, xmax + 2), size1d(ymin - 2, ymax + 3));
